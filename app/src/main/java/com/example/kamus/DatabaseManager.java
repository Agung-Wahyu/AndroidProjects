...
import android.database.sqlite.SQLiteOpenHelper;//untuk interaksi dng database melalui Instance dari kelas SQLiteOpeb Helper
...
public class DatabaseManager {
    ...
    public ArrayList<ArrayList<Object>> ambilSemuaBaris() {
        ...
        Cursor cur;
        try {
            cur = db.query(NAMA_TABEL, new String[] { ROW_INDO, ROW_JAWA },
